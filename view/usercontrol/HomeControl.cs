...
namespace BTL_LTTQ_NHOM3_HETHONGBANGIAY.view.usercontrol
{
    ...
    {
        public event UserEvent showAllProduct;
        ...
        private int getRevenueToday()
        {
            ...
            if (Int32.TryParse(data.RunSQL(sql), out sum))
            {
                return sum;
            }
            else
        ...
        private void getRevenueTuesday()
        {
            ...
            if (total2 > total)
            {
                ...
                btnSellMonday.BackColor = Color.Red;
            }
            else if (total >= total2)
            {

                btnSellMonday.BackColor = Color.Orange;
            }
            btnSellMonday.Visible = true;
